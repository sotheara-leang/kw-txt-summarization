...
class Decoder(nn.Module):
    ...
    def __init__(self):
        ...
        self.lstm = nn.LSTMCell(conf.get('emb-size'), conf.get('w_d-hidden-size'))

        self.y_concat = nn.Linear(2 * conf.get('w_e-hidden-size') + conf.get('emb-size'), conf.get('emb-size'))
